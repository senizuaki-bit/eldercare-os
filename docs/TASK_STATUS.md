...
| M04 Emergency | READY_FOR_REVIEW | codex/m04-emergency | passed | complete release gates; GitHub PR pending publish; P0=0, P1=0 |
...
- Commit/PR: branch `codex/m04-emergency`; one M04 commit and GitHub PR will be added during publish. The branch contains only the emergency-response milestone and retains M05 navigation as disabled future affordances.
